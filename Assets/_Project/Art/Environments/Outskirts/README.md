# Outskirts — Asset Specifications

## What goes here
Background art for the Outskirts biome — the first biome of a run. One backdrop plus
optional ambient overlays.

## Files required for launch (per GDD §19, §23)
| Filename | Dimensions | Format | Notes |
|----------|------------|--------|-------|
| bg_outskirts.png | 1920×1080 | PNG or JPG | Primary biome backdrop |
| bg_outskirts_overlay.png | 1920×1080 | PNG, transparent | Optional ambient overlay (fog, particles) |

## File naming convention
`bg_<biome>.png` for the backdrop; `bg_<biome>_overlay.png` for ambient overlays.

## Production order (priority)
1. bg_outskirts (the player's first impression of the game)
2. bg_outskirts_overlay (atmospheric polish)
